...
%\begin{verbatim}
%Hallo zusammen,
%in der dritten Vorlesung hatte ich erwähnt, dass Haskells Syntax
%darauf verzichtet, Blöcke (von Definitionen) mittels Sonderzeichen 
%abzugrenzen und zu strukturieren.  Andere Programmiersprachen bedienen sich hier typischerweise Zeichen wie {, } und ;.
